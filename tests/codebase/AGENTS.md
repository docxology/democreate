# AGENTS.md — tests/codebase/

- Mirrors `src/democreate/codebase/`; a new module there needs a `test_*.py` here.
...
- Run scoped: `.venv/bin/python -m pytest -q tests/codebase/` (no `--cov`).
