...
| `07_evaluation.md` | Measured benchmarks (`@fig:latency`), testability (690 collected tests, ≥90% gate), the content verifier, tamper-evident provenance + 4K geometry, two real videos (re-rendered in noir) with stills (`@fig:video_stills`) |
