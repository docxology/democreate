# AGENTS.md — tests/narration/

- Mirrors `src/democreate/narration/`; a new module there needs a `test_*.py` here.
...
- Run scoped: `.venv/bin/python -m pytest -q tests/narration/` (no `--cov`).
