...
The test gate is the primary reproducibility check. It runs the full 664-test suite against real artifacts and enforces the ≥90% coverage threshold configured in `pyproject.toml`, which the current suite clears at 92.63%:
