...
| `07_evaluation.md` | Measured benchmarks (`@fig:latency`), testability (625 tests / 3 skipped, ≥90% gate at ~95%), the content verifier, tamper-evident provenance + 4K geometry, two real videos (re-rendered in noir) with stills (`@fig:video_stills`) |
