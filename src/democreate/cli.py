...
# Media-facing commands live in :mod:`democreate._cli_media`; they are
# registered here so the CLI surface is unchanged.
from ._cli_media import gif as _gif_cmd  # noqa: E402
from ._cli_media import render as _render_cmd  # noqa: E402
from ._cli_media import stego as _stego_cmd  # noqa: E402
from ._cli_media import thumbnail as _thumbnail_cmd  # noqa: E402
from ._cli_media import verify as _verify_cmd  # noqa: E402

app.command()(_render_cmd)
app.command()(_verify_cmd)
app.command()(_thumbnail_cmd)
app.command()(_gif_cmd)
app.command()(_stego_cmd)
