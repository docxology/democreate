# AGENTS.md — tests/translation/

- Mirrors `src/democreate/translation/`; a new module there needs a `test_*.py` here.
...
- Run scoped: `.venv/bin/python -m pytest -q tests/translation/` (no `--cov`).
