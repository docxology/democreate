"""Synthetic virtual-desktop frame renderer (the heart of capture).

Split out of :mod:`democreate.capture.screen` (agent refactoring lane); the
public surface remains importable from :mod:`democreate.capture.screen`.
...
rich), falling back to a small keyword set otherwise.
"""
