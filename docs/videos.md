...
12. **Stat-card slide** — *"by the numbers"* (691 tests · 8 subsystems · 5 themes
...
*Video 1 — the "by the numbers" stat-card slide (691 tests · 8 subsystems · 5 themes · 4K · 0 binary deps), the `FrameState.stats` surface, lifted from the encoded 4K noir render.*
